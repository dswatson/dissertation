...
# Causal Shapley values extension

This is a fork of the [shapr](https://github.com/NorskRegnesentral)
project developed by NorskRegnesentral. It contains an extension for
computing causal Shapley values, which has been described in the paper
titled “Causal Shapley Values: Exploiting Causal Knowledge to Explain
Individual Predictions of Complex Models”, authored by Tom Heskes, Evi
Sijben, Ioan Gabriel Bucur and Tom Claassen, which has been published in
the proceedings of NeurIPS 2020. This forked repository is incorporated
as a submodule into the
[CauSHAPley](https://gitlab.science.ru.nl/gbucur/CauSHAPley) package,
which is developed by the same authors as a Code Supplement to the
NeurIPS paper.
